...
<Preview>
  <Story name="Big" isSmall="false" parameters={{
    design: figmaConfig('179%3A0')
  }}>{{
  components: { Header },
  template: `
  <div>
    <Header size="350px" :nonDrop= "[{ title: 'No Dropdown' }]" :drop= "[{ title: 'Dropdown',items: ['ITEM 1', 'ITEM 2', 'ITEM 3']}]" />
...
<Preview>
  <Story name="Small" isSmall="true"  parameters={{
    design: figmaConfig('179%3A0')
  }}>{{
  components: { Header },
  template: `
