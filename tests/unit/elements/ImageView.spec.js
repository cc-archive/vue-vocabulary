...
describe('ImageView.vue', () => {
  ...
  it ('centering image is working correctly', () => {
  ...
  it ('hovering image is working correctly', () => {
    defaultConfig.propsData.isHoverable = IS_HOVERABLE;
    const wrapper = getWrapper();
  ...
  it ('rendering the topAddons correctly', () => {
    defaultConfig.propsData.isHoverable = IS_HOVERABLE;
    defaultConfig.slots = {
        topAddons: SLOT
    };
  ...
  it ('rendering the bottomAddons correctly', () => {
    defaultConfig.propsData.isHoverable = IS_HOVERABLE;
    defaultConfig.slots = {
        bottomAddons: SLOT
    };
